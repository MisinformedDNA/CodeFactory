...
namespace CodeFactory.IDE.VisualStudio.ProjectSystem
{
    ...
    /// </summary>
    public interface IVsProjectCSharpActions
    {
        /// <summary>
        /// Gets a list of csharp documents that implement the target class name.
        /// </summary>
        /// <param name="source">The source project to search.</param>
        ...
        Task<IReadOnlyList<VsDocumentCSharp>> GetCSharpDocumentByClassNameAsync (VsProject source, string name, string targetNamespace = null);
        ...
        Task<IReadOnlyList<VsDocumentCSharp>> GetCSharpDocumentByInterfaceNameAsync (VsProject source, string name, string targetNamespace = null);
        ...
        Task<IReadOnlyList<VsDocumentCSharp>> GetCSharpDocumentsAsync (VsProject source, bool allLevels = false);
    }
}