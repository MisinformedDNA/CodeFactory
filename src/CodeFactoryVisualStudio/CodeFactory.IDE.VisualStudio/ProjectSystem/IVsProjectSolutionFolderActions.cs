...
namespace CodeFactory.IDE.VisualStudio.ProjectSystem
{
    ...
    /// </summary>
    public interface IVsProjectSolutionFolderActions
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="source">The project to get folders from.</param>
        ...
        Task<IReadOnlyList<VsProjectFolder>> GetProjectFoldersAsync(VsProject source, bool allLevels = false);
