...
namespace CodeFactory.IDE.VisualStudio.ProjectSystem
{
    ...
    /// </summary>
    public interface IVsProjectFolderModelCSharpActions
    {
        /// <summary>
        ...
        Task<string> GetCSharpNamespaceAsync();
        ...
        Task<IReadOnlyList<VsDocumentCSharp>> FindCSharpDocumentsByClassNameAsync( string name,
        ...
        Task<IReadOnlyList<VsDocumentCSharp>> FindCSharpDocumentsByInterfaceNameAsync(string name,
            bool allLevels = false);
