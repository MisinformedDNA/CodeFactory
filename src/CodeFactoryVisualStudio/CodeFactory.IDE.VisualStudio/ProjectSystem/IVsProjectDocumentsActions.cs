...
namespace CodeFactory.IDE.VisualStudio.ProjectSystem
{
    ...
    /// </summary>
    public interface IVsProjectDocumentsActions
    {
        /// <summary>
        ...
        Task<IReadOnlyList<VsDocument>> FindDocumentsAsync(VsProject source, string fileName);
        ...
        /// <returns>List of all documents in the project with the file name, or an empty list if none are found.</returns>
        Task<IReadOnlyList<VsDocument>> GetDocumentsAsync(VsProject source, bool allLevels = false);
