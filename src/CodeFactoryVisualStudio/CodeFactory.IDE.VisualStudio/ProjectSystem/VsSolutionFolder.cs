...
namespace CodeFactory.IDE.VisualStudio.ProjectSystem
{
    ...
    /// </summary>
    public abstract class VsSolutionFolder:VsProjectSystemModel,IVsSolutionFolder
    {
        ...
        protected VsSolutionFolder(bool isLoaded, bool hasErrors, IReadOnlyList<ModelException<ProjectSystemModelType>> modelErrors,
            string name, bool hasParent, bool hasChildren) : base(isLoaded, hasErrors, modelErrors, ProjectSystemModelType.SolutionFolder, name)
        {
        ...
        public abstract Task<IReadOnlyList<VsProjectSystemModel>> GetChildrenAsync(bool allChildren);
