...
namespace CodeFactory.IDE.VisualStudio.Language.CSharp
{
    ...
    public abstract class CsType:CsModel,ICsType
    {
        ...
        private readonly WellKnownLanguageType _wellKnownType;
        #endregion
        ...
        protected CsType(bool isLoaded, bool hasErrors, bool loadedFromSource, SourceCodeType language, bool isGeneric,
            ...
            bool isEnum, bool isDelegate, bool isTuple, IReadOnlyList<CsTupleTypeParameter> tupleTypes, WellKnownLanguageType wellKnownType,
        ...
        /// </summary>
        public WellKnownLanguageType WellKnownType => _wellKnownType;
