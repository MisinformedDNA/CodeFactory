...
namespace CodeFactory.IDE.VisualStudio.Language.CSharp
{
    ...
    public abstract class CsAttributeParameterValue:CsModel,ICsAttributeParameterValue
    {
        ...
        /// <summary>
        /// Gets the raw value assigned to the parameter. This will be populated if the property <see cref="ICsAttributeParameterValue.ParameterKind"/> is not set to 'Array'
        /// </summary>
        ...
        /// <summary>
        /// The enum value provides the name of the enumeration value that was provided. This will be populated if the property <see cref="ICsAttributeParameterValue.ParameterKind"/> is set to 'Enum'
        /// </summary>
