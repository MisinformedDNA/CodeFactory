...
namespace CodeFactory.IDE.VisualStudio.UserInterface
{
    /// <summary>
    ...
    public  class VsUserControl:UserControl
    {
        ...
        /// </summary>
        // ReSharper disable once InconsistentNaming
        protected readonly IVsBaseActions _actions;
        ...
        public VsUserControl(IVsBaseActions actions, ILogger logger) : base()
        {
            _logger = logger;
            _actions = actions;
            WindowTitle = string.Empty;
