...
{
    /// <summary>
    /// Workflow command base implementation that support the <see cref="VsCSharpSource"/> model.
    /// </summary>
    public abstract class CSharpSourceWorkflowCommandBase: WorkflowCommandBase<VsCSharpSource>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        protected CSharpSourceWorkflowCommandBase(ILogger logger, string commandName, string description, string id, string category, IEnumerable<IWorkflowCommandEnableRule<VsCSharpSource>> enableRules = null) : base(logger, commandName, description, id, category, enableRules)
        {
            //Intentionally blank
        }
    }
