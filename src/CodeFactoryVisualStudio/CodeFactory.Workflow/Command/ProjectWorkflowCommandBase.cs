...
{
    /// <summary>
    /// Workflow command base implementation that support the <see cref="VsProject"/> model.
    /// </summary>
    public abstract class ProjectWorkflowCommandBase: WorkflowCommandBase<VsProject>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        protected ProjectWorkflowCommandBase(ILogger logger, string commandName, string description, string id, string category, IEnumerable<IWorkflowCommandEnableRule<VsProject>> enableRules = null) : base(logger, commandName, description, id, category, enableRules)
        {
            //Intentionally blank
        }
    }
