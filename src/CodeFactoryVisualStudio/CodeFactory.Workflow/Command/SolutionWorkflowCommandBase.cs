...
{
    /// <summary>
    /// Workflow command base implementation that support the <see cref="VsSolution"/> model.
    /// </summary>
    public abstract class SolutionWorkflowCommandBase:WorkflowCommandBase<VsSolution>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        protected SolutionWorkflowCommandBase(ILogger logger, string commandName, string description, string id, string category, IEnumerable<IWorkflowCommandEnableRule<VsSolution>> enableRules = null) : base(logger, commandName, description, id, category, enableRules)
        {
            //Intentionally blank
        }
    }
